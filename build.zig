...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "Engine12" is the name you will use in your source code to
                // import this module (e.g. `@import("Engine12")`). The name is
    ...
    // Display available build commands instead of running the app
